...
- [ ] On the user's workspace: `get_architecture_blueprint("add caching to Module A")` returns a structurally valid result with ≥3 similar features, ≥2 recommended modules, ≥1 insertion point, all verifiable.
